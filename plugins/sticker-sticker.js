...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*[❗𝐈𝐍𝐅𝐎❗]RESPOND TO A VIDEO, IMAGE OR INSERT THE LINK OF AN IMAGE TERMINATION.jpg WHICH WILL BE CONVERTED INTO A STICKER, YOU MUST RESPOND OR USE

THE COMMAND ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply('*[❗𝐈𝐍𝐅𝐎❗] THE LINK/URL/LINK IS INVALID, THE END OF THE LINK/URL/LINK SHOULD BE.jpg, EXAMPLE: ${usedPrefix}s https://telegra.ph/file/0dc687c61410765e98de2.jpg*');
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
    ...
    else throw '*[❗𝐈𝐍𝐅𝐎❗] AN ERROR OCCURRED, PLEASE TRY AGAIN. RESPOND TO A VIDEO, IMAGE OR INSERT THE LINK OF AN IMAGE TERMINATION.jpg WHICH WILL BE CONVERTED INTO STICKER*';
  }
};
handler.help = ['sfull'];
