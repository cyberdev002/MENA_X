...
const handler = async (m, { command, usedPrefix, conn, text }) => {
  if (!text) throw `_*< MIZTY - YTDOWNLOAD />*_\n\n*[ ℹ️ ] You need the name of the YouTube video.*\n\n*[ 💡 ] Example:* _${usedPrefix + command} freeky mobbing legendry_\n\n*[ 💡 ] Example 2:* _${usedPrefix + command} https://youtube.com/watch?v=1WKGrVJudts`;
if (enviando) return;
    enviando = true
  try {
    const apiUrls = [
