...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[📌] Give me Instagram Link , Example: ${usedPrefix + command}* https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link`;
  m.reply(`*[📥] WAIT A MOMENT, THIS PROCESS CAN LAST BETWEEN 2 AND 10 MINUTES DEPENDING ON THE LENGTH OF THE VIDEO ⏳......*`);
  /*try {
